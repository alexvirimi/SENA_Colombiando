...
<footer class="footer padding-block-150">
  <nav>
    <div>
      <a href="${pageContext.request.contextPath}/index" class="full-logo-div">
        <%-- Full logo SVG (nombre + tagline) --%>
    ...
    <div class="padding-block-150">
      <ul role="list" class="nav-list">
        ...
        <li class="footer-list-item">
          <a href="${pageContext.request.contextPath}/tours">Servicios</a>
        </li>
        <li class="footer-list-item">
